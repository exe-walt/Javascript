...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        // selecting USD by default as FROM currency and GHS as TO currency
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/df50dd94535a0f0b73b41e19/latest/${fromCurrency.value}`;
